...
const { createProfile, deleteProfile, getProfile, followUser, unfollowUser, getProfileById, followSuggestions } = require("../controllers/Profile");
...
router.get("/followsuggestion",auth,followSuggestions);
